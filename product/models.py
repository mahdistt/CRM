...
class ProductInfo(models.Model):
    ...
    img_catalog = models.ImageField(verbose_name=' کاتالوگ عکس', upload_to='catalogs/img')
    pdf_catalog = models.FileField(verbose_name='کاتالوگ پی دی اف', upload_to='catalogs/pdf')
